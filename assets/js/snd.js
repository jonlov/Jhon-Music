    ...
    var Snd = function(t, a, s, o) {
        ...
        var audio = {
            ...
            time: function(event) {
                ...
                t.find('.trackProgress').css({ 'width': Math.round(percentageOfSlider) + "px" });
            ...
            loop: function() {
                (audio.looped == false) ? a.loop = audio.looped = true: a.loop = audio.looped = false;
            },
            mute: function() {
                (audio.muted == false) ? a.muted = audio.muted = true: a.muted = audio.muted = false;
            },
            toggle: function() {
        ...
        var playlist = {
            current: 0,
            init: (function() {
                if ($.isArray(s)) t.find('.playlist_item').first().addClass('playing');
            })(),
            update: function() {
        ...
        var listener = (function() {
            ...
            // t.find('.time').on('click', audio.settime);
